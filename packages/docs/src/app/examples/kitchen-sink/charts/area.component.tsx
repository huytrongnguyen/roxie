...
const data = [
  ...
  const { year, china, japan, usa } = item;
  return {
    year,
    china: china.parseInt(),
    japan: japan.parseInt(),
    usa: usa.parseInt(),
  } as GDP
})
      ...
      <div className="auto-scroll-y p-3">
        <div className="card mb-3">
          ...
          <div className="card-body">
            <div className="card">
              <div className="card-header text-center">Economic Development in the USA, Japan and China</div>
              <div className="card-body">
                <Chart  store={GDPStore}
                        series={{ type: 'area', xField: 'year', yField: ['china','japan','usa'] }} />
              </div>
            </div>
          </div>
